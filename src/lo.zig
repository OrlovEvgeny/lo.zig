...
pub const ScanIterator = slice.ScanIterator;
pub const scan = slice.scan;
pub const scanAlloc = slice.scanAlloc;
pub const WindowIterator = slice.WindowIterator;
pub const window = slice.window;
pub const InterleaveIterator = slice.InterleaveIterator;
pub const interleave = slice.interleave;
